			...
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					<div class="w3layouts-contact-form-top">
						<h3>Get in touch</h3>
						<p>Complete your world recognized American degree in Sri Lanka
With the release of A/Level results many students and parents are looking for university education options in Sri Lanka and overseas. With the limited state university options, and high competition for them international degree programmes have become the choice for many students and parents</p>
					</div>
					<div class="agileits-contact-address">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i>0773272746</li>
							<li><i class="fa fa-phone fa-envelope" aria-hidden="true"></i> <span><a href="mailto:example@email.com">bencinenihan@gmail.com</a></span></li>
			...
			<div class="agile-footer-grids">
				...
				<div class="col-md-4 agile-footer-grid">
					...
					<ul class="w3agile_footer_grid_list">
						<li>Ut aut reiciendis voluptatibus maiores <a href="#">http://bencinenihan@gmail.com</a> alias, ut aut reiciendis.
				...
				<div class="col-md-2 agile-footer-grid">
					<h4>INTAKE</h4>
					<ul>
						<li>1ST JAN<a href="single.html">Curabitur</a></li>
						<li>1ST MARCH <a href="single.html">Fusce urna</a></li>
						<li>1ST JUN <a href="single.html">Praesent</a></li>
						<li>1ST SEPT <a href="single.html">Malesuada </a></li>
						<li>ST NOV <a href="single.html">Cum sociis</a></li>
					</ul>
				</div>
				<div class="col-md-2 agile-footer-grid">
					<h4>Navigation</h4>
